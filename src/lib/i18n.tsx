...
const dict = {
  ...
  "home.promos": { kk: "Акциялар", ru: "Акции", en: "Promotions" },
  "home.buyOnline": { kk: "Көлікті толықтай онлайн сатып ал", ru: "Купите автомобиль полностью онлайн", en: "Buy a car fully online" },
  "home.buyOnlineSub": { kk: "Тексерілген көліктер, несие, сақтандыру және жеткізу — бір қосымшада.", ru: "Проверенные авто, кредит, страхование и доставка — в одном приложении.", en: "Verified cars, credit, insurance and delivery — in one app." },
  "home.browse": { kk: "Көліктерді қарау", ru: "Смотреть авто", en: "Browse cars" },
  "promo.credit.title": { kk: "Несие — 21% бастап", ru: "Кредит — от 21%", en: "Loan from 21%" },
  "promo.credit.desc": { kk: "Бастапқы жарнасыз, 7 жылға дейін. Онлайн шешім 5 минутта.", ru: "Без первого взноса, до 7 лет. Решение онлайн за 5 минут.", en: "No down payment, up to 7 years. Online decision in 5 minutes." },
  "promo.credit.cta": { kk: "Есептеу", ru: "Рассчитать", en: "Calculate" },
  "promo.delivery.title": { kk: "Есігіңізге жеткізу", ru: "Доставка до двери", en: "Delivery to your door" },
  "promo.delivery.desc": { kk: "Қазақстан бойынша жабық автовозбен 1–7 күн ішінде.", ru: "По Казахстану в закрытом автовозе за 1–7 дней.", en: "Across Kazakhstan in an enclosed carrier in 1–7 days." },
  "promo.delivery.cta": { kk: "Тапсырыс беру", ru: "Заказать", en: "Order" },
  "promo.ai.title": { kk: "AI көмекші", ru: "AI помощник", en: "AI assistant" },
  "promo.ai.desc": { kk: "Бюджетіңіз бен талаптарыңызға сай көлік таңдап береді.", ru: "Подберёт авто под ваш бюджет и пожелания.", en: "Finds a car that fits your budget and needs." },
  "promo.ai.cta": { kk: "Сұрау", ru: "Спросить", en: "Ask" },
  "promo.insurance.title": { kk: "ОГПО + КАСКО", ru: "ОГПО + КАСКО", en: "MTPL + CASCO" },
  "promo.insurance.desc": { kk: "Бағасы төмен полистерді 5 минутта рәсімдеңіз.", ru: "Оформите выгодные полисы за 5 минут.", en: "Issue affordable policies in 5 minutes." },
  "promo.insurance.cta": { kk: "Есептеу", ru: "Рассчитать", en: "Calculate" },
  ...
  "pay.history": { kk: "Төлемдер", ru: "Платежи", en: "Payments" },
  "pay.delivery": { kk: "Жеткізу", ru: "Доставка", en: "Delivery" },
